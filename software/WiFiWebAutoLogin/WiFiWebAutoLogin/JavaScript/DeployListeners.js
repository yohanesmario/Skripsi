(function () { // Self executing function
    ...
    function addClickListener(el, tagName, idx) {
        el.addEventListener("click", function () {
            ScriptNotifyHandler.notify("document.getElementsByTagName(\"" + tagName + "\")[" + idx + "].click();");
        });
    }
    function addChangeListener(el, tagName, idx) {
        el.addEventListener("change", function () {
            ScriptNotifyHandler.notify("document.getElementsByTagName(\"" + tagName + "\")[" + idx + "].value = " + JSON.stringify(document.getElementsByTagName(tagName)[idx].value) + ";");
        });
    }
